    ...
    <div className="justify-center   md:h-[301vh] h-[380vh] relative top-55 -z-40 bg-[#191B1F]  gap-5  w-full md:w-[100%] mx-auto flex-wrap  ">
      ...
      <div className="bg-[#232428] w-full md:w-[100%] h-[332vh] md:h-[220vh] md:ml-30 ml-0 md:sticky top-10   rounded-md z-10 md:mx-0">
        <div className="flex justify-between items-center mt-5 mr-10">
          <h1 className="font-[poppins] text-lg text-white pl-5 pt-5">PlayStation</h1>
            ...
            playstations.map((playstation) => (
              <div key={playstation.id} className="w-full mb-3">
                <Link href={`/inside/${playstation.id}`} className="block">
                  <div className="rounded-md transition md:flex   gap-3 ">
                    <Image
                    ...
                    <div className="flex flex-col gap-4">
                      <h3 className="bg-[#191B1F] w-20 text-center px-0 rounded-sm py-1 mb-5 text-[12px] text-[#0000FF] font-[poppins] font-semibold">
                        {playstation.title}
                      </h3>
                      <p className="text-white font-[Poppins] md:text-2xl text-md w-80  hover:text-[#0000FF] -mt-5 md:w-80">
