...
const Xb = async () => {
  ...
  return (
    ...
    <div className="justify-center   md:h-[301vh] h-[360vh] relative top-55  bg-[#191B1F] z-10 gap-5  w-full md:w-[100%] mx-auto flex-wrap  ">
      
      
      <div className="bg-[#232428] w-full md:w-[100%] h-[342vh] md:h-[220vh] md:ml-30 ml-0 md:sticky top-10    rounded-md  md:mx-0">
        <div className="flex justify-between items-center mt-5 mr-10">
          <h1 className="font-[poppins] text-lg text-white pl-5 pt-5">XBox</h1>
        ...
        <div className="p-5 flex flex-col gap-3 mt-3">
                ...
                <Link href={`/inside/${post.id}`} className="block">
                  <div className="rounded-md transition md:flex   gap-10 ">
                    ...
                    <div className="flex flex-col gap-4">
                      <h3 className="bg-[#191B1F] w-20 text-center px-0 rounded-sm py-1 mb-5 text-[12px] text-[#008B8B] font-[poppins] font-semibold">
                        {post.title}
                      </h3>
                      <p className="text-white font-[Poppins] md:text-2xl text-md w-80  hover:text-[#008B8B] -mt-5 md:w-80">
                        {post.description}
                      </p>
                      ...
                      <div className="flex text-[12px] mt-2 mb-5 font-[poppins] font-normal items-center gap-1 text-gray-400">
                        ...
                        <span className="font-[poppins] text-sm text-[#008B8B]">
                          Read more
                        </span>
                      </div>
                    </div>
          ...
          <button className=" text-white py-2 w-30 px-4 rounded-md">
            Thats All
          </button>
        </div>
      </div>
