...
const posts = [
  {
    ...
    imageurl:"https://res.cloudinary.com/dvqhcm07a/image/upload/v1756975709/mark-decile-WA84FtTi7NU-unsplash_m7rjtj.jpg"
},

 {
    ...
    imageurl:"https://res.cloudinary.com/dvqhcm07a/image/upload/v1756975708/guglielmo-basile-FOT822IZaY0-unsplash_gjtqay.jpg"
},
...

{
    ...
    imageurl:"https://res.cloudinary.com/dvqhcm07a/image/upload/v1756975709/mika-baumeister-HUyICL8qbEE-unsplash_oia36q.jpg"
},
                ...
                <div className="rounded-md   transition flex gap-2 ">
                  ...
                  <div className="flex  flex-col gap-4">
                    ...
                    <p className="text-gray-400 text-sm">
                      L orem ipsum, or lipsum as it is sometimes known, is dummy
                      text used in laying out print, graphic or web desi…
                    </p>
                    <div className="flex text-[12px] mt-2 mb-5 font-[poppins] font-normal items-center gap-1 text-gray-400">
                      ...
                      <Image
                        ...
                        height={16}
                      />
                      <h1 className="font-[poppins] text-sm text-[#0000FF]">
