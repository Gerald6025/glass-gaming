...
const New = async () => {
  ...
  return (
    ...
    <div className="justify-center   md:h-[301vh] h-[250vh] relative top-55 -z-40 bg-[#191B1F]  gap-5  w-full md:w-[100%] mx-auto flex-wrap  ">
      
      
      <div className="bg-[#232428] w-full md:w-[100%] h-[200vh] md:h-[120vh] md:ml-30 ml-0 md:sticky top-10   rounded-md z-10 md:mx-0">
        <div className="flex justify-between items-center mt-5 mr-10">
          <h1 className="font-[poppins] text-lg text-white pl-5 pt-5">News</h1>
        ...
        <div className="p-5 flex flex-col gap-3 mt-3">
                ...
                <Link href={`/inside/${post.id}`} className="block">
                  <div className="rounded-md transition md:flex   gap-10 ">
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <p className="text-white font-[Poppins] md:text-2xl text-md w-80  hover:text-[#3D55EF] -mt-5 md:w-80">
                        {post.description}
                      </p>
                      ...
                      <div className="flex text-[12px] mt-2 mb-5 font-[poppins] font-normal items-center gap-1 text-gray-400">
                        ...
                        <span className="font-[poppins] text-sm text-[#3D55EF]">
                          Read more
                        </span>
                      </div>
                    </div>
          ...
          <button className="bg-[#3D55EF] text-white py-2 w-30 px-4 rounded-md">
            More Posts
          </button>
        </div>
      </div>
